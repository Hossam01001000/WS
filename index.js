...
(async () => {
  ...
  await page.goto(
    "https://www.linkedin.com/jobs/search/?f_AL=true&keywords=frontend%20developer&location=Canada&refresh=true"
  );
  ...
  let fishes = (arg) => {
    ...
    return ul.lastElementChild.getAttribute("data-test-pagination-page-btn");
  });
      ...
      for (let link of jobLinks) {
        ...
        if (applingButton) {
          ...
          let company = document
            .querySelector('[class="jobs-unified-top-card__company-name"]')
            .textContent.replace(/\n/g, "")
            .trim();
          applingButton.click();
          await wait(1);
            ...
            while (weStillHere) {
              ...
              if (nextbutton) {
                ...
                try {
                  ...
                  if (
                    current ==
                    newDoc.querySelector('[class="display-flex ph5 pv2"]')
                      .innerHTML
                  ) {
