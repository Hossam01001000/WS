...
(async () => {
  ...
  for (let country of lg) {
    try {
      await page.goto(
        `https://www.linkedin.com/jobs/search/?f_AL=true&keywords=frontend%20developer&location=${country.trim()}&refresh=true`
      );
